...
ggplot(plotDF_lasso, aes(x = probs)) + 
  ...
  labs(title = "Overlayed Histogram of Predicted Probabilities",
       x = "Predicted Probability", caption = "Figure 7") +
  theme_bw() +
...
ggplot(plotDF_RF, aes(x = probs)) + 
  geom_histogram(binwidth = 0.02, 
                 ...
                 position = "identity", alpha = 0.65) +
  labs(title = "Overlayed Histogram of Predicted Probabilities",
       x = "Predicted Probability", caption = "Figure 9") +
  theme_bw() +
  scale_fill_discrete(name = "Observed Y") 
...
After 5 folds of cross validation, we have the model with largest AUC (0.8806) value with `max_dempth = 6`, `ets = 0.01`, `gamma = 1`, `subsample = 0.5`. Figure 10 shows the resulting AUCs given the values of learning rate and tree depth, the ligher color and bigger size of the dot suggests higher AUC value.
...
ggplot(plotDF_xgb, aes(x = probs)) + 
  geom_histogram(binwidth = 0.02, 
                 ...
                 position = "identity", alpha = 0.65) +
  labs(title = "Overlayed Histogram of Predicted Probabilities",
       x = "Predicted Probability", y = "Number of Flights", caption = "Figure 11") +
...
ggplot(plotDF_stack, aes(x = probs)) + 
  geom_histogram(binwidth = 0.02, 
                 ...
                 position = "identity", alpha = 0.65) +
  labs(title = "Overlayed Histogram of Predicted Probabilities",
       x = "Predicted Probability", caption = "Figure 12") +
  theme_bw() +
  scale_fill_discrete(name = "Observed Y") 
